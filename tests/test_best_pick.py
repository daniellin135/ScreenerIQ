...
def test_best_pick_report_model_tiers():
    """Test generating report with model tier options (gemini-3.6-flash, gemini-3.7-flash, antigravity)."""
    enriched_sample = {
        "ticker": "MSFT",
    ...
    for model_tier in ["gemini-3.6-flash", "gemini-3.7-flash", "antigravity"]:
